          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:block ml-10 space-x-8"> 
                <a className="text-purple-900 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">Find Work</a>
                <a className="text-purple-900 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">Find Talent</a>
                <a className="text-purple-900 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200">Messages</a>
              </div>
            </div>
